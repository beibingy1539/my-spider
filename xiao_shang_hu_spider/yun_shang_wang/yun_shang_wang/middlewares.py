...
from yun_shang_wang.proxy_test import Proxy_start
from yun_shang_wang.logging_app import *
import random, re
from yun_shang_wang.config_user_agent import web_user_agent


class YunShangWangSpiderMiddleware(object):
...
class YunShangWangDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
