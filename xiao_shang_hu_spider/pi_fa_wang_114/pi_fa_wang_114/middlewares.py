...
from pi_fa_wang_114.proxy_test import Proxy_start
from pi_fa_wang_114.logging_app import *
import random, re
from pi_fa_wang_114.config_user_agent import web_user_agent



class PiFaWang114SpiderMiddleware(object):
...
class PiFaWang114DownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
