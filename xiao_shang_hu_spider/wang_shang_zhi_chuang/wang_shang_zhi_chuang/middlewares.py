...
from wang_shang_zhi_chuang.proxy_test import Proxy_start
from wang_shang_zhi_chuang.logging_app import *
import random, re
from wang_shang_zhi_chuang.config_user_agent import web_user_agent


class WangShangZhiChuangSpiderMiddleware(object):
...
class WangShangZhiChuangDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
