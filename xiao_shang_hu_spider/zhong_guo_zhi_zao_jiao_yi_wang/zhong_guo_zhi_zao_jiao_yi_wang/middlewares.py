...
from zhong_guo_zhi_zao_jiao_yi_wang.proxy_test import Proxy_start
from zhong_guo_zhi_zao_jiao_yi_wang.logging_app import *
import random, re
from zhong_guo_zhi_zao_jiao_yi_wang.config_user_agent import web_user_agent


class ZhongGuoZhiZaoJiaoYiWangSpiderMiddleware(object):
...
class ZhongGuoZhiZaoJiaoYiWangDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
